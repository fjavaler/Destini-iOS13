...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice: String)
    {
        ...
        {
            storyPath.append("0")
            currentStory = getChoice1Destination()
        }
        else if userChoice == getChoice2()
        {
            storyPath.append("1")
            currentStory = getChoice2Destination()
        }
        else
        {
    ...
    fileprivate func getChoice2Destination() -> Int
    {
        return stories[currentStory].choice2Destination
    }
    
    fileprivate func getChoice1Destination() -> Int
    {
